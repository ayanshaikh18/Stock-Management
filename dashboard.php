        ...
        <div class="col s8">
            ...
            <?php
                ...
                try
                {
                    ...
                    $query=$dbhandler->prepare("select * from stock where username=? and quantity < minstock");
            ...
            ?>
            <div class="red">
                <h6 style="padding-bottom: 7px;padding-top: 7px;color:black;" class="center large">Hey <?php echo $username; ?>..!! Hurry up..!! Please order these items.</h6>
            </div>
            <table>
                <?php 
            ...
            ?>
                <div class="green lighten-2">
                    <h6 style="padding-bottom: 7px;padding-top: 7px;color:black;" class="center large">There are no stocks which are going to be empty.</h6>
                </div>
            <?php 
