    ...
    <div class="row">
        ...
        <div class="col s8">
                ...
                if(isset($_GET['catagory']))
                {
                    ...
                    try
                    {
                        ...
                        $dbhandler->setAttribute(PDO::ATTR_ERRMODE,PDO::ERRMODE_EXCEPTION);
                                ...
                                $query=$dbhandler->prepare("select * from stock where username=? and catagory=?");
                                $query->execute(array($username,$catagory));
            ...
            <?php
                ...
                ?>
                    <div class="red">
                        <h6 style="padding-bottom: 7px;padding-top: 7px;color:black;" class="center large">There is no stock registered of catagory <?php echo $catagory?>.</h6>
                    </div>
